...
import net.jmb19905.config.WorldHeightType;
...
public class SkyUtils {
    ...
    public static float[] getSunriseColor(Level level, double z, float partialTicks) {
        ...
        float sunHeight = (float) sunHeight(level, z, partialTicks);
        if (sunHeight >= -threshold && sunHeight <= threshold) {
            float f3 = sunHeight / threshold * 0.5F + 0.5F;
